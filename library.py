...
def get_and_transform_current_results(year):
    ...
    rac_points["index"] = rac_points["index"].str.replace("_RAC", "").dropna(how='any', axis=0, inplace=True)
    spr_points["index"] = spr_points["index"].str.replace("_SPR", "").dropna(how='any', axis=0, inplace=True) 
